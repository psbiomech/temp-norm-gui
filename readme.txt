   ...
   environment variable. 
	...
	A. Locate the name of the environment variable to set, using the 
	 ...
	 NOTE: When deploying C and C++ standalone applications, it is possible
               to run the shell script file run_OptimalHipKnee_280510.sh on UNIX and Mac
...
3. Create packages that contain the following files, based on what
   you are deploying: 
	...
	All Platforms:
		* OptimalHipKnee_280510.ctf (Component Technology File archive,
		  platform-dependent on target machine)
			
	Windows:
		* MCRInstaller.exe (self-extracting MATLAB Component Runtime
		  library archive)  
		* OptimalHipKnee_280510.exe (application created by MATLAB Compiler)
	UNIX:
		* MCRInstaller.zip (MATLAB Component Runtime library 
	 	  archive - manual unzip required)
		* OptimalHipKnee_280510 (application created by MATLAB Compiler)
		* run_OptimalHipKnee_280510.sh (shell script that can be run 
	...
	All Platforms:            
		* OptimalHipKnee_280510.dll (shared library, file extension 
		  varies by platform)
		* OptimalHipKnee_280510.h (library header file)
		* OptimalHipKnee_280510.ctf (Component Technology File archive,
		  platform-dependent on target machine)
	...
	* OptimalHipKnee_280510.ctf (Component Technology File archive)	
	* OptimalHipKnee_280510.xml (documentation files)
	* OptimalHipKnee_280510.pdb (program database file - if 
	  DEBUG option selected)
	* OptimalHipKnee_280510.dll (component assembly file)
	* MCRInstaller.exe (self-extracting MATLAB Component Runtime
	  library archive)  
	...
	* OptimalHipKnee_280510.ctf (Component Technology File archive)
	* OptimalHipKnee_280510_1_0.dll (component containing 
	  compiled M-code)
	...
	* OptimalHipKnee_280510.jar (Java archive containing Java 
	  interface to M-code in OptimalHipKnee_280510.ctf)
	* OptimalHipKnee_280510.ctf (Component Technology File archive,
	  platform-dependent on target machine)
