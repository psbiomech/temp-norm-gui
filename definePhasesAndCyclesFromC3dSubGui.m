function varargout = definePhasesAndCyclesFromC3dSubGui(varargin)
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @definePhasesAndCyclesFromC3dSubGui_OpeningFcn, ...
                   'gui_OutputFcn',  @definePhasesAndCyclesFromC3dSubGui_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function definePhasesAndCyclesFromC3dSubGui_OpeningFcn(hObject, eventdata, handles, varargin)
handles.phasesAndCycles = [];
handles.output = handles.phasesAndCycles;
handles.numberOfPhasesAndCycles = varargin{1};
handles.eventTimes = varargin{2};
handles.eventNames = varargin{3};

for i = 1:20;
    eval(['set(handles.popupmenuStartPhase' num2str(i) ', ''String'', [cellstr(''Starting event: ''); cellstr(handles.eventNames)]);'])
    eval(['set(handles.popupmenuEndPhase' num2str(i) ', ''String'', [cellstr(''Ending event: ''); cellstr(handles.eventNames)]);'])
end
...
function varargout = definePhasesAndCyclesFromC3dSubGui_OutputFcn(hObject, eventdata, handles)
